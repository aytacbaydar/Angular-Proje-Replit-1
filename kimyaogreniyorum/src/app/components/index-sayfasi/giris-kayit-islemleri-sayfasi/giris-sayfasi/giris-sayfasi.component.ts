...
@Component({
  selector: 'app-giris-sayfasi',
  standalone: false,
  templateUrl: './giris-sayfasi.component.html',
  styleUrl: './giris-sayfasi.component.scss',
})
export class GirisSayfasiComponent implements OnInit {
  loginForm!: FormGroup;
